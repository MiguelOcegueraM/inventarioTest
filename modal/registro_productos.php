	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			<form class="form-horizontal" action="nuevo_producto.php" method="post" id="guardar_producto" name="guardar_producto" enctype="multipart/form-data" >
					...
					<div class="form-group">
						<label for="stock" class="col-sm-3 control-label">Cantidad Stock: </label>
						<div class="col-sm-8">
